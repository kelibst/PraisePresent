...
- **Status:** in-progress (build verified; `v0.1.0-baseline` tag pending user commit decision)
...
- **Pending:** `v0.1.0-baseline` tag — awaiting user decision on what to commit (see PM note).
