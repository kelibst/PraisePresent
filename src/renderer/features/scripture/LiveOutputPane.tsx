import { ChevronRight, Lock, MonitorX, SkipForward, Square } from 'lucide-react';
...
// of deck[index+1]. Live controls (Next / Black / Clear) drive the present domain
// via the parent's callbacks. Scripture is edit-locked, surfaced as an affordance
// (§ design). Pure view — no window.api here (§1.3).
...
export default function LiveOutputPane({ live, onNext, onBlack, onClear }: Props) {
