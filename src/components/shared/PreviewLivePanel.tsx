        ...
        <div className="flex-1 p-6 border-r border-gray-200 dark:border-gray-700">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 h-full">
            ...
            <div className="p-6 h-full">
              ...
              ) : previewItem && previewItem.type === "placeholder" ? (
                <div className="space-y-4">
                  {/* Placeholder Display */}
                  <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/30 dark:to-blue-900/30 rounded-lg p-8 text-center">
                    <div className="text-4xl mb-4">🎵</div>
                    <div className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                      {previewItem.content.mainText}
                    </div>
                    <div className="text-lg text-gray-600 dark:text-gray-300 mb-4">
                      {previewItem.content.subText}
                    </div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      Ready since {previewItem.content.timestamp}
                    </div>
                  </div>
        ...
        <div className="flex-1 p-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 h-full">
            ...
            <div className="p-6 h-full">
              ...
              ) : liveItem && liveItem.type === "placeholder" ? (
                <div className="space-y-4">
                  {/* Live Placeholder Display */}
                  <div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/30 dark:to-blue-900/30 rounded-lg p-8 text-center border-2 border-green-200 dark:border-green-700">
                    <div className="text-4xl mb-4">🎵</div>
                    <div className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                      {liveItem.content.mainText}
                    </div>
                    <div className="text-lg text-gray-600 dark:text-gray-300 mb-4">
                      {liveItem.content.subText}
                    </div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      Live since {liveItem.content.timestamp}
                    </div>
